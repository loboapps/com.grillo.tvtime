...
drop function if exists tvtime_sync_show(integer, text, text, text, integer, integer, jsonb, jsonb, date);
...
grant execute on function tvtime_sync_show(integer, text, text, text, text, text, integer, integer, jsonb, jsonb, date) to authenticated, service_role;
revoke execute on function tvtime_sync_show(integer, text, text, text, text, text, integer, integer, jsonb, jsonb, date) from public, anon;
