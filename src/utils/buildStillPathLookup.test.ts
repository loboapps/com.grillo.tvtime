...
function makeEpisode(seasonNumber: number, episodeNumber: number, stillPath: string | null): TvmazeEpisode & { season_number: number } {
  return { season_number: seasonNumber, episode_number: episodeNumber, name: `S${seasonNumber}E${episodeNumber}`, air_date: null, airstamp: null, still_path: stillPath, summary: null }
}
